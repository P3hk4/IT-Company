...
import second.project.Service.AccountService;
import second.project.Service.AuthoritiesService;
import second.project.Service.ProjectService;
import second.project.Service.UserService;
...
public class MyController {
    ...
    public String saveAdminUpdate(@ModelAttribute("acc")Account account){
        accountService.saveOrUpdateAcc(account);
        System.out.println(account.getAuthority().equals(("ROLE_CLIENT")));
