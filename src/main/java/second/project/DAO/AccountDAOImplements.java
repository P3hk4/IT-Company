...
import second.project.entity.Employee;
...
public class AccountDAOImplements implements AccountDAO {
    ...
    public List<Account> getAllEmployees() {
        ...
        List<Account> accounts = session.createQuery("from Account where (authority = 'ROLE_EMPLOYEE') or (authority = 'ROLE_ADMIN')",Account.class).getResultList();
        return accounts;
    }
